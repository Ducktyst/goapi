...
type Database interface {
	GetExchangeRate(ctx context.Content) (result []ExchangeRate, err error)
	CreateExchangeRate (ctx context.Content) error
...
func (d *DB) GetExchangeRate(ctx context.Context) (result []Class, err error) {
...
func (d *DB) CreateExchangeRate(ctx context.Context, c Class) error {
